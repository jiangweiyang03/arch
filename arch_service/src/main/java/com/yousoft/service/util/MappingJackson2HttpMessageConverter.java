 ...
 * and write JSON using <a href="http://jackson.codehaus.org/">Jackson 2.x's</a> {@link ObjectMapper}.
 * 
 * <p>
...
public class MappingJackson2HttpMessageConverter extends AbstractHttpMessageConverter<Object>
    ...
    private Object readJavaType(JavaType javaType, HttpInputMessage inputMessage) {
        try {
            ...
            return RequestUtil.readRequestBody(javaType, inputMessage, objectMapper);
     ...
     * <p>
     * The default implementation returns {@code typeFactory.constructType(type, contextClass)}, but this can be
